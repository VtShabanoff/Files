...
import com.skillbox.car.ItemOffsetDecoration
...
import com.skillbox.car.databinding.FragmentLayoutGridVehicleBinding
import com.skillbox.car.dialog.DialogCreateVehicle
import jp.wasabeef.recyclerview.animators.ScaleInAnimator
import java.lang.Exception
import kotlin.random.Random

class GridLayoutFragment: Fragment(), TransferringDate {
    private var vehicleAdapter by AutoClearedValue<VehicleAdapter>()
    private var _binding: FragmentLayoutGridVehicleBinding? = null
    private val binding: FragmentLayoutGridVehicleBinding
        get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = FragmentLayoutGridVehicleBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState != null){
            vehicles = savedInstanceState.getParcelableArrayList(KEY_LINEAR_GRID)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putParcelableArrayList(KEY_LINEAR_GRID, vehicles as ArrayList)
    }
    ...
    companion object {
        ...
        const val KEY_LINEAR_GRID = "key_linear_grid"
    }
}